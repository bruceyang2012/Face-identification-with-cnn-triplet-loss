## Description
This is a implementation of cnn+triplet-loss for face detection written by keras, which is the first step of my **FaceID system**. You can find another two repositories  as follows:
